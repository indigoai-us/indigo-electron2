export default function IconFormBubble({
    size = 16, // or any default size of your choice
    className = "",
    colorClass = "text-white-300"
  }) {
    return (
      <div className={colorClass}>
        <svg className="fill-current" width={size} height={size} viewBox="0 0 38 32" xmlns="http://www.w3.org/2000/svg">
        <path d="M36.5,0h-35C0.673,0,0,0.673,0,1.5v29C0,31.327,0.673,32,1.5,32h35c0.827,0,1.5-0.673,1.5-1.5v-29
        ...
        <path d="M31.5,14h-25C5.673,14,5,14.673,5,15.5v10C5,26.327,5.673,27,6.5,27h25c0.827,0,1.5-0.673,1.5-1.5v-10
        ...
        <path d="M31.5,5h-25C5.673,5,5,5.673,5,6.5v3C5,10.327,5.673,11,6.5,11h25c0.827,0,1.5-0.673,1.5-1.5v-3
